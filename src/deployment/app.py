...
config = load_config()
model_path = project_root / config["paths"]["model_dir"] / "random_forest_pipeline.pkl"
try:
...
app = FastAPI(
    ...
    description="API to predict who can keep a habit based on multiple features (actually it predicts anxiety levels, that is part of the four models selected to enhance this predictor)."
)
